...
public class DrivetrainConstants {
    ...
    public final static double cancoderTLOffset = 243.2;
    public final static double cancoderTROffset = 13.88;
    public final static double cancoderBLOffset = 157.4;
    public final static double cancoderBROffset = 268.68;
