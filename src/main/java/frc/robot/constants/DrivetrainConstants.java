...
public class DrivetrainConstants {
        ...
        public static final double robotRotKp = 5; // (rad/sec)/rad
        public static final double robotRotKd = 2.5; // (rad/sec)/(rad/sec)=1
