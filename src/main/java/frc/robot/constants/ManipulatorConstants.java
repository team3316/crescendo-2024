...
public class ManipulatorConstants {
    ...
    // positioning
    private static final double gearRatio = 1.0 / 12.0; // TODO: Is this 1:12 or 1:9?
    ...
    public class NotePosition { // TODO: Calibrate
        ...
        public static final double amp = 0.0; // install in amp. in meters
        public static final double trap = 0.0; // install in trap. in meters
    }
    ...
    public static final double collectingPercentage = 0.6;
}
