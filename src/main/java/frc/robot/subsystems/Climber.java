...
public class Climber extends SubsystemBase {
    ...
    private void climb() {
        ...
        if (_leftSpool.getOutputCurrent() < ClimberConstants.maxCurrent) {
            this._leftSpool.set(ClimberConstants.feedforward + balancePID);
        }
        if (_rightSpool.getOutputCurrent() < ClimberConstants.maxCurrent) {
            this._rightSpool.set(ClimberConstants.feedforward - balancePID);
        }
    }
